@php
    ...
    $formPanelPosition = Helper::getFormPanelPosition();
    $mobileFormPanelPosition = Helper::getMobileFormPanelPosition();
    $emptyPanelBackgroundImageUrl = Helper::getEmptyPanelBackgroundImageUrl();
    $emptyPanelBackgroundImageOpacity = Helper::getEmptyPanelBackgroundImageOpacity();
    $showEmptyPanelOnMobile = Helper::getShowEmptyPanelOnMobile();
    $emptyPanelView = Helper::getEmptyPanelView();
@endphp
